...
public class FruitFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_fruit_drink,container,false);
    ...
    public void initButton(){
        button11=(Button)view.findViewById(R.id.fdf_button_11);
        button12=(Button)view.findViewById(R.id.fdf_button_12);
        button13=(Button)view.findViewById(R.id.fdf_button_13);
        button21=(Button)view.findViewById(R.id.fdf_button_21);
        button22=(Button)view.findViewById(R.id.fdf_button_22);
        button23=(Button)view.findViewById(R.id.fdf_button_23);
        button31=(Button)view.findViewById(R.id.fdf_button_31);
        button32=(Button)view.findViewById(R.id.fdf_button_32);
        button33=(Button)view.findViewById(R.id.fdf_button_33);
        button41=(Button)view.findViewById(R.id.fdf_button_41);
        button42=(Button)view.findViewById(R.id.fdf_button_42);
        button43=(Button)view.findViewById(R.id.fdf_button_43);
